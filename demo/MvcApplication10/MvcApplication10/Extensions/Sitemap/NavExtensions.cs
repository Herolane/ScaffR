namespace MvcApplication10.Extensions.Sitemap
{
    ...
    public static class NavExtensions
    {
        ...
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, bool showStartingNode)
        {
            return Nav(helper, helper.Provider.RootNode, true, showStartingNode, Int32.MaxValue, false);
        }
        ...
        /// <param name="showStartingNode">Show starting node if set to <c>true</c>.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, SiteMapNode startingNode, bool startingNodeInChildLevel, bool showStartingNode)
        {
            return Nav(helper, startingNode, startingNodeInChildLevel, showStartingNode, Int32.MaxValue, false);
        }
        ...
        /// <param name="showStartingNode">Show starting node if set to <c>true</c>.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, bool startFromCurrentNode, bool startingNodeInChildLevel, bool showStartingNode)
        {
        ...
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, int startingNodeLevel, int maxDepth, bool allowForwardSearch, bool drillDownToContent)
        {
            ...
            return Nav(helper, startingNode, true, false, maxDepth + 1, drillDownToContent);
        }
        ...
        /// <param name="allowForwardSearch">if set to <c>true</c> allow forward search. Forward search will search all parent nodes and child nodes, where in other circumstances only parent nodes are searched.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, int startingNodeLevel, int maxDepth, bool allowForwardSearch)
        {
            return Nav(helper, startingNodeLevel, maxDepth, allowForwardSearch, false);
        }
        ...
        /// <param name="drillDownToContent">if set to <c>true</c> [drill down to content].</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, int startingNodeLevel, bool startingNodeInChildLevel, bool showStartingNode, int maxDepth, bool allowForwardSearch, bool drillDownToContent)
        {
            SiteMapNode startingNode = GetStartingNode(GetCurrentNode(helper.Provider), startingNodeLevel, allowForwardSearch);
            if (startingNode == null)
            {
            ...
            return Nav(helper, startingNode, startingNodeInChildLevel, showStartingNode, maxDepth + 1, drillDownToContent);
        }
        ...
        /// <param name="maxDepth">The max depth.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, int startingNodeLevel, bool startingNodeInChildLevel, bool showStartingNode, int maxDepth)
        {
            return Nav(helper, startingNodeLevel, startingNodeInChildLevel, showStartingNode, maxDepth, false, false);
        }
        ...
        /// <param name="drillDownToContent">if set to <c>true</c> [drill down to content].</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, SiteMapNode startingNode, bool startingNodeInChildLevel, bool showStartingNode, int maxDepth, bool drillDownToContent)
        {
            return Nav(helper, null, startingNode, startingNodeInChildLevel, showStartingNode, maxDepth, drillDownToContent);
        }
        ...
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, string templateName)
        {
            return Nav(helper, templateName, helper.Provider.RootNode, true, true, Int32.MaxValue, false);
        }
        ...
        /// <param name="showStartingNode">Show starting node if set to <c>true</c>.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, string templateName, bool startFromCurrentNode, bool startingNodeInChildLevel, bool showStartingNode)
        {
            SiteMapNode startingNode = startFromCurrentNode ? GetCurrentNode(helper.Provider) : helper.Provider.RootNode;
            return Nav(helper, templateName, startingNode, startingNodeInChildLevel, showStartingNode, Int32.MaxValue, false);
        }
        ...
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, string templateName, int startingNodeLevel, int maxDepth, bool allowForwardSearch, bool drillDownToCurrent)
        {
            ...
            return Nav(helper, templateName, startingNode, true, true, maxDepth + 1, drillDownToCurrent);
        }
        ...
        /// <param name="maxDepth">The max depth.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, string templateName, int startingNodeLevel, int maxDepth)
        {
            return Nav(helper, templateName, startingNodeLevel, maxDepth, false, false);
        }
        ...
        /// <param name="drillDownToCurrent">Should the model exceed the maxDepth to reach the current node</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, string templateName, int startingNodeLevel, bool startingNodeInChildLevel, bool showStartingNode, int maxDepth, bool allowForwardSearch, bool drillDownToCurrent)
        {
            SiteMapNode startingNode = GetStartingNode(GetCurrentNode(helper.Provider), startingNodeLevel, allowForwardSearch);
            if (startingNode == null)
            {
            ...
            return Nav(helper, templateName, startingNode, startingNodeInChildLevel, showStartingNode, maxDepth + 1, drillDownToCurrent);
        }
        ...
        /// <param name="maxDepth">The max depth.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, string templateName, int startingNodeLevel, bool startingNodeInChildLevel, bool showStartingNode, int maxDepth)
        {
            return Nav(helper, templateName, startingNodeLevel, startingNodeInChildLevel, showStartingNode, maxDepth, false, false);
        }
        ...
        /// <param name="drillDownToCurrent">Should the model exceed the maxDepth to reach the current node</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, string templateName, SiteMapNode startingNode, bool startingNodeInChildLevel, bool showStartingNode, int maxDepth, bool drillDownToCurrent)
        {
            ...
            return helper
                ...
                .DisplayFor(m => model, "Sitemap/Nav");
        }
        ...
        /// <param name="maxDepth">The max depth.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, string templateName, SiteMapNode startingNode, bool startingNodeInChildLevel, bool showStartingNode, int maxDepth)
        {
            return Nav(helper, templateName, startingNode, startingNodeInChildLevel, showStartingNode, maxDepth, false);
        }
        ...
        private static SitemapHelperModel BuildModel(MvcSiteMapHtmlHelper helper, SiteMapNode startingNode, bool startingNodeInChildLevel, bool showStartingNode, int maxDepth, bool drillDownToCurrent)
        {
            ...
            if (mvcNode != null)
            {
                nodeVisible = mvcNode.VisibilityProvider.IsVisible(
                    node, HttpContext.Current, NavSourceMetadata);
            }
            ...
            {
                // Add node?
                var nodeToAdd = SiteMapNodeModelMapper.MapToSiteMapNodeModel(node, mvcNode, NavSourceMetadata);
                if (nodeVisible)
                {
        ...
        public static SiteMapNode GetStartingNode(SiteMapNode currentNode, int startingNodeLevel, bool allowForwardSearch)
        {
            ...
            if (startingNode.ParentNode != null)
            {
